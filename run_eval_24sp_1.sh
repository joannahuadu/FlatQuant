...
#   --tasks winogrande openbookqa mmlu arc_challenge \
#   --lm_eval_batch_size 16 \
#   >> "$LOG_DIR/eval_w4a4_24sp_l20.0001_l31_alpha0_ep60_lr5e-3_s2ep30_s3ep45_invuseperm.log" 2>&1 &
...
#   --tasks winogrande openbookqa mmlu arc_challenge \
#   --lm_eval_batch_size 16 \
#   >> "$LOG_DIR/eval_w4a4_24sp_l20.0001_l31_alpha0_ep15_lr5e-3_invuseperm.log" 2>&1 &
...
#   --tasks winogrande openbookqa mmlu arc_challenge \
#   --lm_eval_batch_size 16 \
#   >> "$LOG_DIR/eval_w4a4_24sp_l20.0001_l30_alpha0_ep30_lr5e-3_invuseperm.log" 2>&1 &
...
#   --tasks winogrande openbookqa mmlu arc_challenge \
#   --lm_eval_batch_size 16 \
#   >> "$LOG_DIR/eval_w4a4_24sp_l20_l31_alpha0_ep15_lr5e-3_usexperm.log" 2>&1 &
...
#   --tasks winogrande openbookqa mmlu arc_challenge \
#   --lm_eval_batch_size 16 \
#   >> "$LOG_DIR/eval_w4a4_24sp_l20_l30_alpha0_ep30_lr5e-3_usexperm_nousexmask_usepredictor.log" 2>&1 &
...
#   --tasks winogrande openbookqa mmlu arc_challenge \
#   --lm_eval_batch_size 16 \
#   >> "$LOG_DIR/eval_w4a4_24sp_l20_l30_alpha0_ep30_lr5e-3_usexperm_usexmask.log" 2>&1 &
...
#   --tasks winogrande openbookqa mmlu arc_challenge \
#   --lm_eval_batch_size 16 \
#   >> "$LOG_DIR/eval_w4a4_24sp_l20_l30_alpha0_ep30_lr5e-3_usexperm_usexmask_usepredictor.log" 2>&1 &
...
nohup env CUDA_VISIBLE_DEVICES=1 python main.py \
  ...
  --tasks winogrande openbookqa mmlu arc_challenge \
  --lm_eval_batch_size 16 \
  >> "$LOG_DIR/eval_w4a4_24sp_r11e-4_ep30_2*layerlr5e-3_layer_lr*10_usexperm_usexmask.log" 2>&1 &