import torch
a = torch.load("./outputs/d04e592bb4f6aa9cfee91e2e20afa771667e1d4b/w4a4/exp_20260210_134116/flat_matrices.pth")
...
print(a[0].keys())
perm_logits = a[0]['mlp.up_gate_trans.x_perm_logits']
